...
const RegisterLayout = () => {
  ...
  return (
    <main
      id="register"
      className="relative z-0 flex h-screen items-center justify-center bg-cover bg-center bg-gradient-to-b from-slate-400 to-slate-300 py-8 text-slate-900 dark:from-slate-800 dark:to-slate-950 dark:text-slate-200"
      style={{
        backgroundImage: 'url("https://www.shutterstock.com/image-photo/hall-building-college-260nw-329767535.jpg")',
      }}
    >
      <CircleDesign />
